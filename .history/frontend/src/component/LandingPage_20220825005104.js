  ...
  return (
    <div className="main">
      <header className="header">
        <span className="title"> Welcome to 10 Academy Scheduler</span>
      </header>
      <main className="body">
        ...
        <div className="card">
          ...
          <div className="text__container">
            ...
            <div className="text">
              <p>
                The following web app was designed so that 10 Academy memebers
              ...
              <p>
                <b>
                  ...
                  that click the "Post Event" button once.
                </b>
              </p>
            </div>
          </div>
        ...
        <div className="footer">
          {!disabled ? (
            ...
            <div>
              <button
                className="post__event"
                onClick={() => {
                  handleClick();
                  setPostDisable((val) => (val = true));
                }}
